...
function setRepeat(){
	repeat = !repeat;//short for if else of true false
...
function setShuffle(){
    ...
    if(shuffle == true){
    	...
    	currentIndex = shufflePlaylist.indexOf(audioElement.currentPlaying.id); //randomize playlist
    }
    else{
